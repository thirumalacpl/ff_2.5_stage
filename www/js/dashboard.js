...
var app = {
	...
	//alert(region+'region');
		//alert(user_id+'user_id');
 $.ajax({url: 'http://staging.eimpressive.com/slim/slim_four_rips/gcm_id_user.php?gcm_regid='+gcm_regid+"&E_Mail="+E_Mail+"&username="+username+"&region="+region+"&user_id="+user_id,
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
